Ever felt the issue where you want to control multiple motors for id'ing them, only to find you can control one at a time? Well, this program is the sared solution to this problem.
